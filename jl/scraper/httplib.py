#! /usr/bin/env python
# This is a hacked version of Python 2.5's (2.4 compatible) httplib.py,
# to handle sites like The Times which claim to be sending a
# chunked response and then drop the connection after one chunk.
# Search for 'ukmedia'.
    ...
    def _read_chunked(self, amt):
        ...
        while True:
            if chunk_left is None:
                line = self.fp.readline()
                if not line: break  # dropped connection - ukmedia hack
                i = line.find(';')
                if i >= 0:
