...
def FindArticles():
    ...
    found = ScraperUtils.FindArticlesFromRSS( scotsman_rssfeeds, u'scotsman', ScrubFunc )
    found = found + ScraperUtils.FindArticlesFromRSS( scotlandonsunday_rssfeeds, u'scotlandonsunday', ScrubFunc )
    return found
